...
Naivebayes.prototype.categorize_list = function (text) {
  var self = this
    , maxProbability = -Infinity
    , minProbaility = Infinity
    , chosenCategory = null
  ...
  .forEach(function (category) {
    ...
    .forEach(function (token) {
      ...
      if (tokenProbability != 0 && !isNaN(tokenProbability))
      {
    ...
    result.probability = logProbability;
    results.push(result);
    result = new result_obj;
  })
